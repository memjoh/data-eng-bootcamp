-- new schema in database to hold tables for analysis
CREATE SCHEMA analysis;

-- check data for accurate datatype creation
SELECT
	MIN(id),
	MAX(id),
	MAX(LENGTH(name)),
...
-- create tables with accurate column datatypes
...
-- insert data from staging into analysis tables
...
-- special: add any missing parts from inventory_parts to parts table
INSERT INTO analysis.parts (
	SELECT DISTINCT
		IP.part_num,
		NULL AS name,
